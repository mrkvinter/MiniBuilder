...
namespace Engine.Editor
{
    public class ReorderableListExtend
    {
        ...
        private readonly ReorderableList orderList;
        ...
        public ReorderableListExtend(SerializedObject serializedObject, string propertyName,
            bool dragable = true, bool displayHeader = true, bool displayAddButton = true,
            bool displayRemoveButton = true)
        {
            this.propertyName = propertyName;
            this.serializedObject = serializedObject;
            property = serializedObject.FindProperty(this.propertyName);
            elementHeights = new List<float>(property.arraySize);
            SetHightLightBackgroundImage();

            orderList = new ReorderableList(serializedObject, property, dragable, displayHeader, displayAddButton,
                displayRemoveButton);
        ...
        private void OnDrawElement(Rect rect, int index, bool active, bool focused)
        {
            ...
            var height = EditorGUI.GetPropertyHeight(element) + EditorGUIUtility.standardVerticalSpacing;
        ...
        protected virtual void OnDrawElementBackground(Rect rect, int index, bool active, bool focused,
            SerializedProperty element, float height)
        {
            if (active)
